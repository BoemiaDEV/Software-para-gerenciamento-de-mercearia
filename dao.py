...
class DaoVenda:
    ...
    def  salvar(cls, venda: Venda):
        with open('venda.txt', 'a') as arq:
            arq.writelines(venda.intensVendidos.nome + "|" + venda.intensVendidos.preco + "|" + venda.intensVendidos.categoria + "|" + venda.vendedor + "|" + venda.comprador + "|" + str(venda.quantidadeVendida) + "|" + venda.data)
            arq.writelines('\n')
